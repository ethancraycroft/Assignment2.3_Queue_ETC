 ...
 * node has its internal data (an object (String, integer, double, etc.)) and pointers to the next 
 * node in the list.
 * 
...
public class GenericNode <T>
{
	...
	private T data;  //data that the object stores - can be any object type (String, integer, double, etc)
